                        ...
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{'register'}}">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" id="inputFirstName" type="text" placeholder="Enter Name" name="name"/>
                                    ...
                                    <div class="mt-4 mb-0">
                                        <div class="d-grid"><input type="submit" value="Register" class="btn btn-primary btn-block" href="login.html"></div>
                                    </div>
                                </form>
                            </div>
